...
import dev.auctoritas.auth.interface.api.ProjectAuthSettingsRequest;
import dev.auctoritas.auth.interface.api.ProjectOAuthSettingsRequest;
import dev.auctoritas.auth.interface.api.ProjectPasswordSettingsRequest;
import dev.auctoritas.auth.interface.api.ProjectSessionSettingsRequest;
import dev.auctoritas.auth.interface.api.ProjectSettingsResponse;
